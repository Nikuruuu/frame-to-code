...
export const landingPage = {
  heading: "Transform Wireframes into Production-Ready React Code",
  subheading:
    "Upload your wireframe and let AI instantly generate clean, efficient React components—saving you hours of development time.",
  description:
    "Frame2Code is your AI-powered solution for turning wireframes into high-quality React code in seconds. Whether you're a developer looking to speed up your workflow or a designer wanting to bridge the gap between design and development, Frame2Code makes it seamless. Simply upload your wireframe, and our AI will analyze and convert it into structured, reusable React components—so you can focus on building, not coding from scratch.",
};
